...
class ProfileFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.txtProfileRole.text = "Quyền hạn: ${tokenManager.getUserRole()}"
    ...
    private fun showEditProfileDialog() {
        ...
        dialogBinding.btnUpdateProfile.setOnClickListener {
            ...
            if (name.isEmpty() && password.isEmpty()) {
                Toast.makeText(context, "Vui lòng nhập thông tin cần thay đổi!", Toast.LENGTH_SHORT).show()
        ...
        lifecycleScope.launch {
            try {
                ...
                if (meRes.isSuccessful && meRes.body() != null) {
                    ...
                    _binding?.txtProfileRole?.text = "Quyền hạn: ${me.role}"
                ...
                if (_binding != null) {
                    Toast.makeText(context, "Lỗi tải thông tin cá nhân!", Toast.LENGTH_SHORT).show()
                }
            }
        }
    }
